...
AuthorDate: Tue Sep 11 10:00:00 2025 +0800
 ...
 2 files changed, 18 insertions(+), 9 deletions(-)"""
        ...
        with patch("subprocess.run") as mock_run:
            ...
            assert not found_first_file, (
                "Should NOT find first commit's filename after switching"
            )
...
AuthorDate: Tue Sep 11 10:00:00 2025 +0800
 ...
 1 file changed, 25 insertions(+), 25 deletions(-)"""
        ...
        with patch("subprocess.run") as mock_run:
            ...
            lines1 = self.view.get_display_lines(
                height=50, width=narrow_width, colors_enabled=True
            )
                ...
                if isinstance(line, tuple):
                    ...
                    if "aaaaaaaa" in text:
                        ...
                        if "commit" in text or color == 3:
                            assert color == 3, (
                                f"Commit SHA should be green, got {color}"
                            )
            ...
            for line in lines2:
                if isinstance(line, tuple):
                    ...
                    if "11111111" in text:
                        ...
                        if "commit" in text or color == 3:
                            assert color == 3, (
                                f"Second commit SHA should be green, got {color}"
                            )
