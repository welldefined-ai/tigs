...
class TestPaneRenderer:
    ...
    def test_draw_pane_with_focus(self, mock_curses):
        ...
        PaneRenderer.draw_pane(mock_stdscr, 0, 0, 10, 20, "Test", True, content, True)
    ...
    def test_draw_pane_without_focus(self, mock_curses):
        ...
        content = ["Line 1"]
        PaneRenderer.draw_pane(mock_stdscr, 0, 0, 10, 20, "Test", False, content, True)

        # Check that bold was NOT turned on
        # For unfocused, we don't use bold
        bold_calls = [
            call for call in mock_stdscr.attron.call_args_list if call[0][0] == 1
        ]  # A_BOLD = 1
    ...
    def test_multi_colored_content(self, mock_curses):
        ...
        PaneRenderer.draw_pane(mock_stdscr, 0, 0, 10, 30, "Test", False, content, True)
    ...
    def test_plain_string_content(self, mock_curses):
        ...
        content = ["Plain text"]
        PaneRenderer.draw_pane(mock_stdscr, 0, 0, 10, 30, "Test", False, content, False)
    ...
    def test_focus_with_colors(self, mock_curses):
        ...
        PaneRenderer.draw_pane(
            ...
            True,
            content,
            True,  # focused and colors enabled
        )
