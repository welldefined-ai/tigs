...
class ValidationResult:
    ...
    def add_error(self, message: str, line: Optional[int] = None, section: Optional[str] = None) -> None:
        """Add an error to the result."""
        self.errors.append(ValidationIssue(Severity.ERROR, message, line, section))

    def add_warning(self, message: str, line: Optional[int] = None, section: Optional[str] = None) -> None:
